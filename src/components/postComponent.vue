<template>
  <div class="grid grid-rows-2 bg-gray-100">
    <div
      class="border overflow-hidden shadow-sm bg-white rounded-lg w-[640px] mx-auto sm:mt-[20px]"
    >
      <form action="" method="post">
        <div class="flex mt-[-20px]">
          ...
          <input
            ...
            placeholder="Ecrivez un coommentaire sur votre activité"
          />
          <button
            @click="addItem"
            class="bg-blue-700 rounded-md text-white sm:text-[16px] sm:ml-[10px] sm:w-[130px] h-[50px] mt-[47px]"
          >
            Publier
          </button>
        </div>
    ...
    >
      <div class="flex ml-[50px]">
        ...
        <div class="mx-4 pt-[24px]">
          <!-- titre -->
          <div>
            <span class="font-bold">Ray Newman</span> est à
      ...
      <img
        :src="selectedImage.url"
        alt="Uploaded Image"
        class="rounded w-full h-[440px] mt-[10px] mx-auto"
      />
    </div>
  </div>
</template>
